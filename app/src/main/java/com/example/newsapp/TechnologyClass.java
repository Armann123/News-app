...
public class TechnologyClass extends Fragment {
    String api = "2e81c3e3af3144b9984262ce39199968";
    ArrayList<ModelClass> modelClassArrayList;
    Recycleradapter adapter;
    String country = "in";
    private RecyclerView technolgy;
    private String category ="technology";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.technologyclass,null);

        technolgy =v.findViewById(R.id.technologyrec);
        modelClassArrayList=new ArrayList<>();
        technolgy.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Recycleradapter(getContext(),modelClassArrayList);
        technolgy.setAdapter(adapter);
