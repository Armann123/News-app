...
public class ScienceClass extends Fragment {
    String api = "2e81c3e3af3144b9984262ce39199968";
    ArrayList<ModelClass> modelClassArrayList;
    Recycleradapter adapter;
    String country = "in";
    private RecyclerView sciencerec;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         ...
         View v= inflater.inflate(R.layout.scienceclass,null);
        sciencerec =v.findViewById(R.id.sciencerec);
        modelClassArrayList=new ArrayList<>();
        sciencerec.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Recycleradapter(getContext(),modelClassArrayList);
        sciencerec.setAdapter(adapter);
