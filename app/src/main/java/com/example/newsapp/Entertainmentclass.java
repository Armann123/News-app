...
public class Entertainmentclass extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.entertainmentclass,null);

        entertainment =v.findViewById(R.id.entertainmentrec);
